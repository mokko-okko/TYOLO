...
def ChangeToOtherMachine(filelist, repo="TYOLO", remote_machine=""):
    """
    ...
    '/home/ubuntu/TYOLO/Data/Street_View_Images/vulnerable/test.jpg'

    Get's converted to

    'C:/Users/Anton/TYOLO/Data/Street_View_Images/vulnerable/test.jpg'
